...
<div class="max-w-7xl mx-auto px-4 py-6">
    ...
    <div class="bg-white/80 p-6 rounded-2xl shadow-xl backdrop-blur-md mt-8 mb-8"> 
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
            <?php $__empty_1 = true; $__currentLoopData = $rekomendasis; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <div class="bg-white border border-gray-300 rounded-xl text-center shadow-sm hover:shadow-md w-full max-w-xs py-6 px-4 flex flex-col justify-between">
                    <div class="flex justify-center mb-4">
                        ...
                        <img src="<?php echo e(asset('artikel_icons/' . $item->icon_path)); ?>" 
                             alt="<?php echo e($item->title); ?> icon" class="w-10 h-10 object-contain">
                        <?php else: ?>
                        <div class="w-10 h-10 bg-gray-200 rounded-full flex items-center justify-center text-gray-400">?</div> 
                        <?php endif; ?>
                    </div>
                ...
                <div class="space-y-3">
                    <div class="flex items-start">
                        ...
                        <div class="ml-3">
                            ...
                            ?>
                            <p class="text-xs text-gray-500"><?php echo e($loginTimeText); ?></p>
                        </div>
                    </div>
                    <div class="flex items-start">
        ...
        <div class="space-y-6">
            ...
            <div class="bg-white/90 rounded-xl shadow-lg p-5 border-l-4 border-yellow-500">
                <div class="flex items-center mb-4">
                    ...
                    <h2 class="text-xl font-semibold text-[#0F1A21]">Peringatan Dini harus</h2>
                </div>
                ...
                <div class="bg-yellow-50 p-3 rounded-lg">
                    ...
                    <p class="text-xs text-yellow-600 mt-1">
                        Diperbarui: <?php echo e(now()->format('d M Y, H:i')); ?> WIB 
                    </p>
                </div>
            </div>
        </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\SEMESTER 6\PROYEK PERANGKAT LUNAK\clone-update\project-ppl-cegahbanjir\resources\views/user/rekomendasi/index.blade.php ENDPATH**/ ?>