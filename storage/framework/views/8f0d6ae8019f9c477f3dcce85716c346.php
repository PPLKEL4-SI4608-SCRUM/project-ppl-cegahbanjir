...
<div class="relative" x-data="{ open: false }" @click.outside="open = false" @close.stop="open = false">
    ...
    <div x-show="open"
            ...
            style="display: none;"
            @click="open = false">
        <div class="rounded-md border border-gray-700 bg-[#0F1A21] py-1">
            <?php echo e($content); ?>

        </div>
    </div>
</div>
<?php /**PATH D:\SEMESTER 6\PROYEK PERANGKAT LUNAK\clone-update\project-ppl-cegahbanjir\resources\views/components/dropdown.blade.php ENDPATH**/ ?>