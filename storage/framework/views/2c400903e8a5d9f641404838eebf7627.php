    ...
    <div class="min-h-screen bg-cover bg-center flex items-center justify-center px-4 sm:px-6 lg:px-8 relative" style="background-image: url('<?php echo e(asset('images/background-banjir.png')); ?>')">
        ...
        <div class="z-10 bg-[#121B22]/90 backdrop-blur-md p-8 sm:p-10 rounded-2xl shadow-2xl w-full max-w-md text-white animate-fade-in-up">
            ...
            <div class="flex flex-col items-center justify-center mb-6 sm:mb-8">
                ...
                <span class="text-xl sm:text-2xl md:text-3xl font-bold text-[#FFA404]">Daftar Akun</span>  
            </div>
            ...
            <form method="POST" action="<?php echo e(route('register')); ?>">
                ...
                <!-- Name -->
                <div class="mb-5">
                    <label for="name" class="block text-sm mb-2 text-white/80 font-medium">Nama Lengkap</label>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="text-center text-sm mt-4">
                    ...
                    <a href="<?php echo e(route('login')); ?>" class="text-[#FFA404] hover:text-yellow-300 transition-colors duration-300 font-medium">Login di sini</a>
                </div>
            </form>
        </div>
    </div>
...
<?php endif; ?><?php /**PATH D:\SEMESTER 6\PROYEK PERANGKAT LUNAK\clone-update\project-ppl-cegahbanjir\resources\views/auth/register.blade.php ENDPATH**/ ?>