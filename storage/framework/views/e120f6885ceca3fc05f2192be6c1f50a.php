    ...
    <div class="py-12">
        <div class="bg-white max-w-5xl mx-auto px-6 py-10 rounded-xl shadow-md">
            ...
            <div class="text-center mb-10">
                <h1 class="text-3xl font-black text-gray-900 mb-2"><?php echo e($rekomendasi->title); ?></h1>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 items-start mb-10">
                ...
                <div class="flex flex-col justify-start items-center space-y-6">
                    ...
                    <img src="<?php echo e(url('artikel_images/' . $rekomendasi->image_path)); ?>" alt="gambar artikel"
                    ...
                    <div class="text-left w-full">
                        ...
                        <div class="flex space-x-4">
                            <img src="<?php echo e(asset('images/facebook.png')); ?>" alt="Facebook"
                                class="w-6 h-6 hover:scale-110 transition">
                            <img src="<?php echo e(asset('images/instagram.jpg')); ?>" alt="Instagram"
                                class="w-6 h-6 hover:scale-110 transition">
                            <img src="<?php echo e(asset('images/whatsapp.jpg')); ?>" alt="WhatsApp"
                                class="w-6 h-6 hover:scale-110 transition">
                        </div>
                    </div>
                </div>
                ...
                <div class="space-y-6">
                    <p class="text-gray-700 text-sm leading-relaxed text-justify">
                        <?php echo nl2br(e($rekomendasi->description)); ?>

                    </p>

                    <div class="flex justify-center space-x-8">
                        <?php $__currentLoopData = $rekomendasi->solutions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="flex flex-col items-center p-2">
                                <div class="text-white rounded-full w-12 h-12 flex items-center justify-center">
                                    <!-- Replace with your flame icon -->
                                    <img src="<?php echo e(url('solution_icons/' . $item->icon_path)); ?>" class="w-6 h-6">
                                </div>
                    ...
                    <?php if($rekomendasi->id == 1): ?>
                        <div class="pt-10">
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                
                                <div class="flex items-center bg-blue-100 p-4 rounded-lg shadow-md">
                                    <img src="<?php echo e(asset('images/dokumen.png')); ?>" alt="Dokumen Penting"
                                ...
                                <div class="flex items-center bg-blue-100 p-4 rounded-lg shadow-md">
                                    <img src="<?php echo e(asset('images/obat.png')); ?>" alt="Obat-Obatan" class="w-12 h-12 mr-4">
                                    <div>
                                ...
                                <div class="flex items-center bg-blue-100 p-4 rounded-lg shadow-md">
                                    <img src="<?php echo e(asset('images/makanan.png')); ?>" alt="Makanan Ringan"
                                        class="w-12 h-12 mr-4">
                                    <div>
                                ...
                                <div class="flex items-center bg-blue-100 p-4 rounded-lg shadow-md">
                                    <img src="<?php echo e(asset('images/selimut.png')); ?>" alt="Pakaian dan Selimut"
                                        class="w-12 h-12 mr-4">
                                    <div>
                        ...
                        <div class="pt-4">
                            ...
                            <div class="flex items-center justify-between">
                                ...
                                <div class="flex flex-col items-center text-center mx-3">
                                    <img src="<?php echo e(asset('images/rusak.png')); ?>" alt="rusak" class="w-10 h-10 mb-2">
                                    <p class="text-sm font-semibold">Cegah<br>kerusakan alat</p>
                                </div>
                                <div class="flex flex-col items-center text-center mx-3">
                                    <img src="<?php echo e(asset('images/korslet.png')); ?>" alt="korslet" class="w-10 h-10 mb-2">
                                    <p class="text-sm font-semibold">Hindari<br>korsleting listrik</p>
                                </div>
                                <div class="flex flex-col items-center text-center mx-3">
                                    <img src="<?php echo e(asset('images/rugi.png')); ?>" alt="rugi" class="w-10 h-10 mb-2">
                            ...
                            <div class="mt-10">
                                ...
                                <div class="flex flex-wrap justify-center gap-6">
                                    <div
                                        ...
                                        <img src="<?php echo e(asset('images/stopkontak.png')); ?>" alt="stopkontak"
                                    ...
                                    <div
                                        class="w-60 bg-white border rounded-lg p-4 shadow hover:shadow-md transition flex flex-col items-center text-center">
                                        <img src="<?php echo e(asset('images/kedapair.png')); ?>" alt="kedap air"
                                            class="w-12 h-12 mb-3">
                                    ...
                                    <div
                                        class="w-60 bg-white border rounded-lg p-4 shadow hover:shadow-md transition flex flex-col items-center text-center">
                                        <img src="<?php echo e(asset('images/prioritas.png')); ?>" alt="prioritas"
                                            class="w-12 h-12 mb-3">
                        ...
                        <div class="pt-4">
                            ...
                            <div class="flex justify-center gap-6 mb-6">
                                <div class="flex flex-col items-center text-center">
                                    <img src="<?php echo e(asset('images/switch-off.png')); ?>" alt="switch off"
                                        class="w-10 h-10 mb-2">
                                    <p class="text-sm font-semibold text-gray-800 leading-tight">Matikan<br>MCB Utama</p>
                                </div>
                                <div class="flex flex-col items-center text-center">
                                    <img src="<?php echo e(asset('images/air.png')); ?>" alt="air" class="w-10 h-10 mb-2">
                                    <p class="text-sm font-semibold text-gray-800 leading-tight">Hindari<br>Genangan Air
                                    </p>
                                </div>
                                <div class="flex flex-col items-center text-center">
                                    <img src="<?php echo e(asset('images/evakuasi.png')); ?>" alt="evakuasi" class="w-10 h-10 mb-2">
                        ...
                        <div class="pt-10">
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 justify-items-center">
                                <div
                                    ...
                                    <img src="<?php echo e(asset('images/resmi.png')); ?>" class="w-10 h-10 mb-2"
                                        alt="Pantau Resmi">
                                ...
                                <div
                                    class="w-full max-w-xs bg-blue-100 p-4 rounded-lg shadow-md text-center flex flex-col items-center">
                                    <img src="<?php echo e(asset('images/gedung.png')); ?>" class="w-10 h-10 mb-2"
                                        alt="Evakuasi Aman">
                                ...
                                <div
                                    class="w-full max-w-xs bg-blue-100 p-4 rounded-lg shadow-md text-center flex flex-col items-center">
                                    <img src="<?php echo e(asset('images/arus.png')); ?>" class="w-10 h-10 mb-2" alt="Hindari Arus">
                                ...
                                <div
                                    class="w-full max-w-xs bg-blue-100 p-4 rounded-lg shadow-md text-center flex flex-col items-center">
                                    <img src="<?php echo e(asset('images/listrik.png')); ?>" class="w-10 h-10 mb-2"
                                        alt="Matikan Listrik">
                    ...
                    <?php if($rekomendasi->id == 7): ?>
                        <div class="flex items-center gap-4 p-4 border rounded-lg shadow-sm">
                            <img src="<?php echo e(asset('images/flood.png')); ?>" alt="flood icon" class="w-10 h-10">
                            <p class="text-sm text-gray-700 text-justify">
                                ...
                                <img src="<?php echo e(asset('images/arrow.png')); ?>" alt="arrow" class="inline w-4 h-4 ml-1">
                            </p>
                        </div>
                    <?php endif; ?>
                </div>
            ...
            <div class="mt-8">
                <a href="<?php echo e(route('dashboard')); ?>" class="text-blue-600 hover:underline text-sm font-medium">← Kembali ke
                    Dashboard</a>
            </div>
        </div>
    </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\SEMESTER 6\PROYEK PERANGKAT LUNAK\clone-update\project-ppl-cegahbanjir\resources\views/rekomendasi/show.blade.php ENDPATH**/ ?>