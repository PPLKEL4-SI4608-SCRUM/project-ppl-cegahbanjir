        ...
        <div class="bg-white rounded-lg shadow p-6 mb-8">
            ...
            <form method="POST" action="{{ route('laporan.store') }}" class="space-y-4" enctype="multipart/form-data">
                ...
                <div>
                    ...
                    <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white" for="file_input">Foto Lokasi
                        Kejadian</label>
                    <input
                            ...
                            @foreach ($reports as $index => $report)
                                <tr class="hover:bg-gray-50">
                                    ...
                                    <td class="px-4 py-2 border"><img class="card-img-top"
                                            src="{{ url('disaster_images/' . $report->disaster_image) }}" alt="image" />
                                    </td>
                                            ...
                                            <div class="relative bg-white rounded-lg shadow-sm dark:bg-gray-700">
                                                ...
                                                <div
                                                    ...
                                                    <button type="submit"
                                                        ...
                                                        update</button>
                                                    <button type="button"
                                                        data-modal-target="popup-modal{{ $report->id }}"
                                                    ...
                                                    <div class="relative p-4 w-full max-w-md max-h-full">
                                                        <div
                                                            ...
                                                            <div class="p-4 md:p-5 text-center">
                                                                ...
                                                                <button data-modal-hide="popup-modal{{ $report->id }}"
                                                                    type="button"
