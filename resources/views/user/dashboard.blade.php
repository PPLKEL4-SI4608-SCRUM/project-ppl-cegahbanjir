...
<div class="max-w-7xl mx-auto px-6 mt-10">
    <div class="bg-white bg-opacity-90 backdrop-blur-md rounded-2xl shadow-lg p-6 text-gray-800">
        ...
        <p class="mb-6">Ini adalah dashboard user <strong>CeBan (Cegah Banjir)</strong>.</p>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6">
            ...
            <div class="bg-[#F8F9FA] rounded-xl shadow p-4 text-center hover:shadow-md transition">
                ...
                <p class="text-sm text-gray-600 mb-3">Input & pantau laporan banjir</p>
                <a href="{{ route('laporan.index') }}" class="bg-[#FFA404] hover:bg-[#0F1A21] text-white font-semibold py-2 px-4 rounded flex items-center justify-center">
            ...
            <div class="bg-[#F8F9FA] rounded-xl shadow p-4 text-center hover:shadow-md transition">
                ...
                <a href="" class="bg-[#FFA404] hover:bg-[#0F1A21] text-white font-semibold py-2 px-4 rounded flex items-center justify-center">
            ...
            <div class="bg-[#F8F9FA] rounded-xl shadow p-4 text-center hover:shadow-md transition">
                ...
                <a href="{{ route('rekomendasi.index') }}" class="bg-[#FFA404] hover:bg-[#0F1A21] text-white font-semibold py-2 px-4 rounded flex items-center justify-center">
