        ...
        <div class="mb-10">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6">
                ...
                <div class="bg-[#F8F9FA] rounded-xl shadow p-4 text-center hover:shadow-md transition border-l-4 border-cyan-500">
                    ...
                    <a href="{{ route('admin.weather.predictions.index') }}" class="bg-[#FFA404] hover:bg-[#0F1A21] text-white font-semibold py-2 px-4 rounded flex items-center justify-center transition">
